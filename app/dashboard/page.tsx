      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link
              href="/practice/translation-fr-en"
            ...
            >
              <h3 className="text-xl font-semibold mb-2">Français vers Anglais</h3>
              <p className="text-gray-600 text-sm">Traduisez des phrases françaises en anglais. Exercices adaptés à votre niveau.</p>
            </Link>

            <Link
              href="/practice/translation-en-fr"
              className="bg-white border-2 border-green-600 text-green-700 p-6 rounded-lg hover:bg-green-50 transition-all shadow-sm hover:shadow-md"
            >
              <h3 className="text-xl font-semibold mb-2">Anglais vers Français</h3>
              <p className="text-gray-600 text-sm">Traduisez des phrases anglaises en français. Renforcez votre compréhension.</p>
            </Link>
